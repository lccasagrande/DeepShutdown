...
BATSIM_ENV_OUTPUT = "../results/bat_0_schedule.csv"
BATSIM_WORKLOAD = "GridGym/gridgym/envs/batsim/files/workloads"
BATSIM_PLATFORM = "GridGym/gridgym/envs/batsim/files/platforms/platform_hg_10.xml"
PYTHON = "python"
...
def run_benchmark(env_type, workload_path, policies, output_fn=None):
	...
	for workload in workloads:
		...
		get_batsched_results(workload_path, ['easy_bf', 'conservative_bf'], BATSIM_WORKLOAD + "/{}".format(workload),
		                     workload, results)
...
def run_battery(env_type, workloads_path, policies, output):
	...
	for workload in workloads:
		...
		result = run_benchmark(env_type, workload_path, policies)
	...
	results.to_csv("{}/{}.csv".format(output, "benchmark"), index=False)
